...
Носорог автоматически несется вперед, перепрыгивает препятствия, пригибается под угрозами и собирает сердечки в воздухе. За каждые 10 лайков включается временный бонус: неуязвимость, ускорение и таймер `LIKE POWER`.
...
- На телефоне:
  - короткий тап по экрану - прыжок
  - удержание на экране - пригнуться
